...
import 'package:h2s/screens/rent_tools/desc_page.dart';

class RentToolsTemplate extends StatelessWidget {
  final RentToolsModel rentToolsModel;

  const RentToolsTemplate({Key? key, required this.rentToolsModel}) : super(key: key);
  @override
          ...
          child: Column(
            children: [
              Image(
                ...
                image: NetworkImage(rentToolsModel.toolImage.toString()),
                fit: BoxFit.cover,
              ),
              SizedBox(
                height: 5,
